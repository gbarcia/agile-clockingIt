...
La manera mas facil de obtener el codigo mas reciente es con Git. Necesitaras instalarlo en tu maquina y luego ejecutar:
...
Instalar Phusion Passenger como servidor web. Tambien se puede usar de forma alternativa Mongrel, pero recomendamos Phusion Passenger.

  gem install passenger
  passenger-install-apache2-module

Seguir las instrucciones para la configuracion del Apache httpd.
