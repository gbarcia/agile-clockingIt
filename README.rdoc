...
Para la configuracion del envio de correos, se debe abrir el archivo environment.rb de la carpeta config y sustituir:
...
el puerto y dominio por el de su configuración predeterminada

=== Instalción y puesta en marcha de Juggernaut
